...
public class PerformanceTestBehavior2 {
	...
	private static void appendToFile(String s) {
		try{
			FileWriter fw = new FileWriter("log\\performanceResultsBehavior2.txt", true);
	...
	private static void initTest() {
		...
		for(int i = 0; i < n ; i++){
			new String(strings[i]).setLogic(new Behavior2());
		}
	...
	private static class Behavior2 implements IStringLogic {
		@Override
